                        ...
                        <div class="accordion-body">
                            <ol>
                                ...
                                <li>
                                    ...
                                    "Transfer", "Kirim Uang",
                                    atau yang serupa, lalu masukkan nomor handphone "087856754195"
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    nomor Whatsapp
                                    "087856754195" agar segera dikonfirmasi oleh Admin dan segera di proses
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <ol>
                                ...
                                <li>
                                    Beberapa aplikasi mungkin meminta anda untuk memasukkan kata sandi, PIN, atau
                                    melakukan verifikasi
                                    lainnya untuk menyelesaikan transfer
                                </li>
                                <li>
