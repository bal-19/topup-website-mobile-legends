                            ...
                            <div class="card bg-dark shadow-lg">
                                <div class="card-body">
                                    <img src="data:../image/product/;base64,<?php echo base64_encode($gambar_produk) ?>"
                                        ...
                                        class="shadow rounded bg-dark mx-auto mt-3 mb-2 d-lg-block d-none"
                                        width="200" />
                                    <img src="../image/wp/wp_ling.jpg" alt
                                        class="shadow rounded bg-dark mx-auto mt-3 mb-2 d-lg-block d-none" width="150">
                                    <div class="row">
                                        <div class="col text-light mt-3">
                                            <h3><?php echo $nama_produk ?></h3>
                                            <p><?php echo $desc_produk ?></p>
                                        ...
                                        <div class="row row-cols row-cols-md">
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control"
                                                        placeholder="Masukkan Email / No HP dari akun Mobile Legends"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control"
                                                        placeholder="Masukkan Password dari akun Mobile Legends"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control"
                                                        placeholder="Request hero max 3. ex: Chou, Hanzo, Akai"
                                                        type="text" name="hero" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <label for="serverid">Catatan</label>
                                                    <textarea class="form-control" placeholder="Catatan untuk penjoki"
                                                        type="text" name="catatan" rows="1"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <label for="serverid">User Id Dan Nickname</label>
                                                    <input class="form-control" placeholder="ex: 12345678, Lemonaru"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input class="form-control"
                                                        placeholder="Masukkan total pembelian. ex: 1, 2, 10"
                                                        type="number" name="total_pembelian" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    <label for="serverid">Login Via</label>
                                                    <select class="form-select mb-3" name="login_via"
