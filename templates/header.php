    ...
    <nav class="navbar navbar-expand-sm bg-dark fixed-top shadow-lg" data-bs-theme="dark">
      <div class="container">
        <a class="navbar-brand" href="http://<?= $_SERVER['SERVER_NAME'] ?>/ZeeShop">
          <img src="http://<?= $_SERVER['SERVER_NAME'] ?>/ZeeShop/image/logo/zeeshop-transformed.png" alt="Logo" width="78" height="50" class="d-inline-block align-text-top img-brand me-4">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav me-auto">
            <li class="nav-item">
              <a class="nav-link me-1" aria-current="page" href="http://<?= $_SERVER['SERVER_NAME'] ?>/ZeeShop">
          ...
          <ul class="navbar-nav ms-auto">
            ...
            ?>
              <a href="http://<?= $_SERVER['SERVER_NAME'] ?>/ZeeShop/account" class="btn btn-secondary btn-circle d-flex justify-content-center align-items-center">
                <?php
                $id = $_SESSION['id'];
            ...
            ?>
              <li class="nav-item">
                <a href="http://<?= $_SERVER['SERVER_NAME'] ?>/ZeeShop/account/auth/login.php" class="btn btn-light">
                  Login
                </a>
                <a href="http://<?= $_SERVER['SERVER_NAME'] ?>/ZeeShop/account/auth/register.php" class="btn btn-outline-light">
                  Daftar
                </a>
              </li>
            <?php
