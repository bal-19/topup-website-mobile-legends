...
<head>
    ...
    <link rel="shortcut icon" href="http://<?= $_SERVER['SERVER_NAME'] ?>/ZeeShop/image/logo/zeeshop-logo.png"
        type="image/x-icon">
        ...
        <nav class="navbar navbar-expand-sm bg-dark fixed-top shadow-lg" data-bs-theme="dark">
            <div class="container">
                <a class="navbar-brand" href="http://<?= $_SERVER['SERVER_NAME'] ?>/ZeeShop">
                    <img src="http://<?= $_SERVER['SERVER_NAME'] ?>/ZeeShop/image/logo/zeeshop-transformed.png"
                    ...
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link me-1" aria-current="page"
                                href="http://<?= $_SERVER['SERVER_NAME'] ?>/ZeeShop">
            ...
            if (isset($_SESSION['no_handphone'])) {
              ?>
                        <a href="http://<?= $_SERVER['SERVER_NAME'] ?>/ZeeShop/account"
              ...
              ?>
                        <li class="nav-item">
                            <a href="http://<?= $_SERVER['SERVER_NAME'] ?>/ZeeShop/account/auth/login.php"
                                class="btn btn-light">
                                Login
                            </a>
                            <a href="http://<?= $_SERVER['SERVER_NAME'] ?>/ZeeShop/account/auth/register.php"
